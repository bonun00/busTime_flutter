...
import 'busApiService.dart'; // API 서비스 파일 추가
...
class _ChilwonState extends State<Chilwon> {
  ...
  Future<void> _fetchBusSchedule() async {
    ...
    await _busApiService.fetchChilwonTimes(_selectedBusNumber!, _selectedStop!);
  ...
  Future<void> _fetchBusRoute(String time, String busNumber) async {
    ...
    if (!_busRoutes.containsKey(time)) {
      List<dynamic> route = await _busApiService.fetchChilwonRoute(busNumber);
      setState(() {
                    ...
                    children: [
                      ...
                      if (_expandedTime == time &&
                        ...
                        Container(
                          ...
                          child: Column(
                            children: _busRoutes[time]!.map((stop) {
                              return ListTile(
                                dense: true,
